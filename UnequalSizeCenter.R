...
simCenter1.data <- data.frame(
  names = c("Cauchy", "Normal", "Laplace"),
  KS = c(KSpowerC[1], KSpowerN[1], KSpowerL[1]),
  AD = c(ADpowerC[1], ADpowerN[1], ADpowerL[1])
)

simCenter2.data <- data.frame(
  names = c("Cauchy", "Normal", "Laplace"),
  KS = c(KSpowerC[2], KSpowerN[2], KSpowerL[2]),
  AD = c(ADpowerC[2], ADpowerN[2], ADpowerL[2])
)

simCenter3.data <- data.frame(
  names = c("Cauchy", "Normal", "Laplace"),
  KS = c(KSpowerC[3], KSpowerN[3], KSpowerL[3]),
  AD = c(ADpowerC[3], ADpowerN[3], ADpowerL[3])
)

simCenter4.data <- data.frame(
  names = c("Cauchy", "Normal", "Laplace"),
  KS = c(KSpowerC[4], KSpowerN[4], KSpowerL[4]),
  AD = c(ADpowerC[4], ADpowerN[4], ADpowerL[4])
)

write_csv(simCenter1.data, path = "C:/internship/simCenter1.data")
write_csv(simCenter2.data, path = "C:/internship/simCenter2.data")
write_csv(simCenter3.data, path = "C:/internship/simCenter3.data")
write_csv(simCenter4.data, path = "C:/internship/simCenter4.data")